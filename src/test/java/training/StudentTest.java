...
public class StudentTest
{
   ...
   {
      Assert.assertEquals( 29, experienceForSingleTraining( Trainer.J, 29 ) );
   }
   ...
   {
      Assert.assertEquals( 15, experienceForSingleTraining( Trainer.J, 30 ) );
   }
   ...
   {
      Assert.assertEquals( 29, experienceForSingleTraining( Trainer.J, 59 ) );
   }
   ...
   {
      Assert.assertEquals( 0, experienceForSingleTraining( Trainer.J, 60 ) );
   }
   ...
   {
      Assert.assertEquals( 49, experienceForSingleTraining( Trainer.M, 49 ) );
   }
   ...
   {
      Assert.assertEquals( 30, experienceForSingleTraining( Trainer.M, 50 ) );
   }
   ...
   {
      Assert.assertEquals( 80, experienceForSingleTraining( Trainer.S, 80 ) );
   }
